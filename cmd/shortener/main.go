...
// - Внедрение зависимостей- инициализируйте основные компоненты вашего приложения, такие как:
//  -- клиент базы данных,
//  -- уровень хранения и обработчики запросов,
//  -- соедините компонентов между собой.
